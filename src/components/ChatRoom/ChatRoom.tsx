            ...
            <div className={s.chatRoomWrapper}>
                ...
                <div className={s.chatContainer}>
                    ...
                    <form onSubmit={sendMessage}>
                        <input placeholder="Don't be shy about leaving your mark..." type="text" value={formValue}
                               onChange={(e) => setFormValue(e.target.value)}/>
                        <button type="submit" className={formValue.length > 0 ? s.sendButtonActive : s.sendButtonHidden}>
